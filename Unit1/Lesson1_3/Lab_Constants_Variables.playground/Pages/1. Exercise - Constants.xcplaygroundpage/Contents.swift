...
print("no, by establishing friends as a constant, and having the value of 78, you make it immutable and unable to update, instead, we should use the var keyword to make it able to beunpdaated")
