...
let divisionTotal = double10 / double3
print(divisiontotal);
print("I think it will still be 3.33 because assigning them doulbe type doesn't double the result")
...
print(even % 2)
print(odd % 2)
print("if the answer is 1, that means that the number is odd, because there is a remainder. if it was even the remainder would be 0")
