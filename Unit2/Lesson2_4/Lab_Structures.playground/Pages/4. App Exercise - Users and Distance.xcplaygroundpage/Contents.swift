...
var jacob = User(name: "Jacob Faski", age:26, height: 68.0, weight: 200.0, activityLevel: 7)
print("User Profile:")
print("Name: \(jacob.name)")
print("Age: \(jacob.age)")
print("Height: \(jacob.height)")
print("Weight: \(jacob.weight)")
print("Activity Level: \(jacob.activityLevel)/10")
...
let trackLap = Distance(meters: 1600)
print(trackLap.meters)  
print(trackLap.feet) 
...
let longHike = Distance(feet: 10000)
print(longHike.feet)
print(longHike.meters)
