...
static var currentUser = User(userName: "Jacob Faski", email:"faskij2995@durhamtech.edu", age: 26)
...
let newUser = User(userName:"Bob Roberts", email: "bob.bob@example.com", age: 35) 
